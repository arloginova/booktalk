...
const contentCls = 'my-auto max-w-[330px]'
const titleCls = 'mt-35 text-2xl uppercase'
const subtitleCls = 'text-xl mt-4 mb-5 leading-[130%]'
const imageCls = 'absolute lg-big:w-[880px] w-[700px] lg-big:h-[550px] h-[450px] right-8 -bottom-3 -z-[1]'
const btnCls = ''

const TestPreviewDesktop = ({ className, setScreen }) => {
