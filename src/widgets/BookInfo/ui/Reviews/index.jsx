...
const wrapperCls = '';
const headCls = 'lg-low:text-xl text-sm flex items-center justify-between lg-low:mb-6 mb-4';
...
const Reviews = ({ className, userReviews, litresLink }) => {
	return (
		<div className={cn(wrapperCls, className)}>
			<div className={headCls}>
				<UiTypography tag='strong' font='Raleway-SB' className={reviewsCountCls}>
					Отзывы{' '}
					<UiTypography font='Muller-R' tag='span' className='text-greyExtra lg-low:ml-3 ml-1'>
