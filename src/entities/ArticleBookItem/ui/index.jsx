...
const wrapperCls = '';
const contentCls = 'flex bg-greyBackground p-main lg-low:rounded-[20px] rounded-[16px]';
const imgCls = 'lg-low:w-[110px] w-[85px] lg-low:h-[170px] h-[130px] lg-low:rounded-[10px] rounded-[6px]';
...
const btnCls = 'lg-low:text-base text-xs lg-low:px-7 px-5 lg-low:pt-3 lg-low:pb-2.2 py-2';
const btnTextCls = 'flex items-center lg-low:gap-x-3 gap-x-2';
const descriptionCls = 'lg-low:text-xl text-sm lg-low:mt-6 mt-4';
const shareBtnCls = 'lg-low:size-16 size-9 rounded-full bg-whiteMain flex justify-center items-center ml-auto leading-none hover:opacity-60 duration-150';
const shareIconCls = 'lg-low:w-5 w-3 lg-low:h-6 h-[14px]';

const ArticleBookItem = ({
							 author,
							 bookTitle,
							 description,
							 className,
